// Event data organized by month periods
    ...
    events: [
      {
        ...
        date: '09',
        weekday: 'FRIDAY • JAN',
        title: 'Chinnakannan Sivasankaran',
      ...
      },
      {
        ...
        date: '24',
        weekday: 'TUESDAY • FEB',
        title: 'Professor Anand Nandkumar',
    ...
    events: [
      {
        ...
        date: '10',
        weekday: 'TUESDAY • MAR',
        title: 'Alpha Circle Influence Series',
      ...
      },
      {
        ...
        date: '14',
        weekday: 'TUESDAY • APR',
        title: 'Alpha Circle Leadership Retreat',
  ...
  },
  {
    ...
    events: [
      ...
      },
      {
        ...
        date: '09',
        weekday: 'TUESDAY • JUN',
        title: 'NextGen Fireside — The Succession Dialogues',
      ...
      },
      {
        ...
        date: '23',
        weekday: 'TUESDAY • JUN',
        title: 'Social Impact - Adopt a School',
    ...
    events: [
      {
        ...
        date: '10',
        weekday: 'TUESDAY • NOV',
        title: 'Alpha Circle Diwali Conclave',
      ...
      },
      {
        ...
        date: '29',
        weekday: 'SUNDAY • NOV',
        title: 'Alpha Circle Legacy Trust',
...
// Navigation items derived from month periods
export const navigationItems = monthPeriods.map((period, index) => ({
  id: period.id,
  label: period.id.toUpperCase().replace('-', '-'),
  index
}));

// Contact information
export const contactInfo = {
  locations: 'Hyderabad • Dubai • Global',
  address: '206 Buziness Square Building, Jubilee Enclave, Hi-Tech City, Hyderabad - 500081',
  phone: '+91 91333 83399',
  email: 'admin@thealphacircle.world',
  copyright: '© 2026 The Alpha Circle. All Rights Reserved. An Invitation-Only Collective for Global Leaders and Legacy Builders.'
};
